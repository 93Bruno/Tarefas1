...
public class Cardapio implements Serializable {
	...
	public Cardapio(int idProduto, String nomeProduto, String descProduto, double valorProduto, String dispProduto) {
   ...
   public Cardapio( String nomeProduto, String descProduto, double valorProduto, String dispProduto) {
